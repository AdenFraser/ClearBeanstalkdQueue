<?php namespace AdenFraser\ClearBeanstalkdQueue\Artisan;
...
class ClearBeanstalkdQueueCommand extends Command {
     ...
     * @var string
     */
    protected $description = 'Clears the Beanstalkd queue by deleting all pending jobs.';
    ...
    public function fire()
    {
        ...
        $this->info('Queue successfully cleared.');
    }           
